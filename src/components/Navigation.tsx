        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="flex items-center space-x-4">
            <div className="hidden items-center space-x-4 md:flex">
              ...
              <a href="#products" className="text-sm font-medium hover:text-blue-600">Deals</a>
            </div>
            <button className="inline-flex h-10 w-10 items-center justify-center rounded-md hover:bg-gray-100" aria-label="Wishlist">
              <Heart className="h-5 w-5" />
            </button>
            <button className="relative inline-flex h-10 w-10 items-center justify-center rounded-md hover:bg-gray-100" aria-label="Cart">
            ...
            <button className="inline-flex items-center rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-100">
